...
describe('NotificationBar tests', () => {
  ...
  describe('getNotificationClass()', () => {
    test('should return is-success by default', () => {
      expect(getNotificationClass()).toEqual('is-success');
    });

    test('should return error class correctly', () => {
      expect(getNotificationClass(NotificationType.Error)).toEqual('is-danger');
    });

    test('should return warning class correctly', () => {
      expect(getNotificationClass(NotificationType.Warning)).toEqual(
        'is-warning'
      );
    });

    test('should return info class correctly', () => {
      expect(getNotificationClass(NotificationType.Info)).toEqual('is-info');
    });
  });
});
